...
Copyright (C) 2018 [Processwall Limited](http://www.processwall.com).

Processwall Limited provides plmOS Core under a dual licence model designed to meet the development 
and distribution needs of both commercial and open source projects.

#### Open Source Projects

Open source projects can redistribute and/or modify plmOS Core under the terms of the 
